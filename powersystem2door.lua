...
local LdoorButton = Button:new(1,3,0,0,4,1,"LDOR")
local leftlightButton = Button:new(1,4,0,0,4,1,"LLIT")
local rightlightButton = Button:new(5,4,0,0,4,1,"RLIT")
--local ventButton = Button:new(3,5,0,0,3,1,"VNT")
local RdoorButton = Button:new(5,3,0,0,4,1,"RDOR")


--OUTPUT FORMAT: 
-- local output = Output:new( side, power consumption, initial activity state, linked button )
-- side is the side which redstone signal will be outputted to.
-- powerconsumption is how much power this output consumes, more means more power consumed.
...
-- power goes out.
-- linked button is the button which controls the output, leave empty for no text.

local leftdoorOutput = Output:new("left", 2, false, LdoorButton)
local rightdoorOutput = Output:new("right", 2, false, RdoorButton)
local leftlightOutput = Output:new("bottom", 1, false, leftlightButton)
local rightlightOutput = Output:new("top", 1, false, rightlightButton)
local powerOutput = Output:new("back", .5 , true)
